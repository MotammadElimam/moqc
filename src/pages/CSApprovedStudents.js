...
class CSApprovedStudents extends React.Component {
    ...
    getStudents = async () => {
        ...
        await axios.get(`https://moqc.ae/api/get_register_students?stage=1&page=${this.state.page}&per_page=${this.state.per_page}&name=${this.state.searchText}`,
            { headers: { "token": token } })
            .then(response => {
                this.setState({
                                                ...
                                                <View style={{ elevation: 1,margin:5 }}>
                                                    ...
                                                    <View style={{ borderWidth: 1, borderRadius: 20,  backgroundColor: "white", borderColor: "#CFDED5" }}>
                                                        ...
                                                        <View style={{  marginTop: 0 ,paddingHorizontal:15,paddingVertical:5}}>
                                                            {/* <Image
                                                                source={{ uri: "https://moqc.ae" + m.profile_pic }}
                                                                style={{
                                                                    height: 80,
                                                                    width: 80,
                                                                    resizeMode: "cover",
